...
-(void)initOrderInfoView{
    ...
    self.orderInfoView = [[UIView alloc]initWithFrame:CGRectMake1(0, 0, 414,100)];
    ...
    orderLabel.font = [UIFont boldSystemFontOfSize:CGFloatMakeY(15)];
    
    _orderTotal = [[UILabel alloc]initWithFrame:CGRectMake1(10, 60, 394, 30)];
    _orderTotal.text = [NSString stringWithFormat:@"总价格 : %@",self.totalPrice];
    _orderTotal.font = [UIFont boldSystemFontOfSize:CGFloatMakeY(15)];
...
-(void)initTableView{
    self.selectPayTabelView = [[UITableView alloc]initWithFrame:CGRectMake1(0,100,414,250) style:UITableViewStylePlain];
...
-(UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    SelectTableViewCell *cell = [tableView dequeueReusableCellWithIdentifier:@"reuseCell"];
    if (cell == nil) {
        cell = [[SelectTableViewCell alloc]initWithStyle:UITableViewCellStyleDefault reuseIdentifier:@"reuseCell"];
    }
    if (indexPath.section == 0) {
        ...
        cell.selectLogo.image = [UIImage imageNamed:@"支付宝"];
...
-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 0) {
        ...
        UIButton *otherBtn = (UIButton *)[self.view viewWithTag:22];
        if (btn.isSelected) {
            btn.selected = NO;
        }else{
